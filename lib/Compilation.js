...
/** @typedef {{create: (data: {contextInfo: {issuer: string, compiler: string}, context: string, dependencies: Dependency[]}, callback: ModuleCallback) => ModuleCallback }} ModuleFactory */
...
class Compilation extends Tapable {
	...
	constructor(compiler) {
		...
		/** @type {Map<Dependency|string, DependencyTemplate|string>} */
